...
namespace BusinessLayer.ValidationRules
{
    public class MessageValidator: AbstractValidator<Message>
    {
        ...
        {
            RuleFor(x => x.ReceiverMail).NotEmpty().WithMessage("Alıcının adresini boş geçemezsiniz");
            ...
            RuleFor(x => x.ReceiverMail).NotEmpty().WithMessage("Email adresi boş geçemezsiniz").EmailAddress().WithMessage("Lütfen mail adresinizi giriniz");
        }
    }
}
